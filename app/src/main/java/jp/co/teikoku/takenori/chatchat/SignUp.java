...
public class SignUp extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptSignUp() {
      ...
      //  String username = mUserNameView.getText().toString();
        ...
        View focusView = null;
/*      データ探索の仕組みが不明なので、もうちょっと後でやる
        // Check for a valid username, if the mUser entered one.
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                String usename=RandomStringUtils.randomAlphabetic(10);
    ...
    private boolean isUsernameValid(String username) {
        ...
        myRef=database.getReference("Main").child("Username").child(username);
        String key=myRef.toString();
        if( database.getReference("Main").child("Username").child(username)!=null){
            validFlag=false;
        }
        return validFlag;
    }
    // Sending topic to DB
    public void sendData(String data,DatabaseReference ref) {
